...
/**
 * help_exit - Print out the exit builtin description
 */
void help_exit(void)
{
...
/**
 * help_unsetenv - Print out the unsetenv builtin description
 */
...
/**
 * help_setenv - Print out the setenv builtin description
 */
...
/**
 * help_env - Print out the env builtin description
 */
void help_env(void)
{
	_puts("env:\n");
